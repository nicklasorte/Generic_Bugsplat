function [max_knn_dist,convex_bound,max_int_dB,radial_bound]=plot_zone_miti_reli_radial_multi_rev4(app,temp_margin,sim_array_list_bs,base_protection_pts,data_label1,string_prop_model,temp_rel,grid_spacing,miti_dB,temp_multi_pt_margin)
