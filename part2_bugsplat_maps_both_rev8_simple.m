function part2_bugsplat_maps_both_rev8_simple(app,rev_folder,folder_names,sim_number,reliability,string_prop_model,grid_spacing,array_reliability_check,tf_calc_rx_angle,tf_recalculate,tf_tropo_cut,tf_server_status,array_bs_eirp_reductions,array_mitigation,tf_rescrap_pathloss)

%%%%%%%%Both Angles and Non-Angles
