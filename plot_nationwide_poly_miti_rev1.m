function plot_nationwide_poly_miti_rev1(app,sim_number,cell_poly_merge,array_mitigation)
...
%%%%'Next step, plot the poly merge with the 11 layers and a color bar on the right'
    ...
    pause(1)
    print(gcf,strcat('Nationwide7_Multi_Rev',num2str(sim_number),'.png'),'-dpng','-r300')
    toc;
    pause(1)
    close(f1)
