function part2_bugsplat_maps_multi_point_rev2(app,rev_folder,folder_names,sim_number,reliability,string_prop_model,grid_spacing,array_reliability_check)
                ...
                if var_exist_min_full_pl_data==2
                    ...
                    for point_idx=1:1:num_pts
                        ...
                        if point_idx==1
                            ...
                            min_full_pl_data=min(min_full_pl_data,pathloss);
                        end
                    end
                        ...
                        for path_idx=1:1:num_pathloss
                            ...
                            if ~isempty(idx_keep)
                                ...
                                if ~isempty(non_inf_keep_grid_pts)==1
                                    ...
                                    xlabel('Longitude')
                                    ylabel('Latitude')
                                    title({strcat(data_label1),strcat('Path Loss Reliability:',num2str(temp_reliability),'%--Pathloss:',num2str(temp_pathloss),'dB:',num2str(max_knn_dist),'km')})
