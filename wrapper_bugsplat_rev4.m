function wrapper_bugsplat_rev4(app,rev_folder,parallel_flag,tf_server_status)
...
[num_chunks]=load_data_num_chunks(app)
...
if tf_calc_rx_angle==1 %%%%%%%%%If we need to do the angles.
    ...
    part1_calc_pathloss_rand_chunkpt_server_rev7(app,rev_folder,folder_names,parallel_flag,sim_number,reliability,confidence,FreqMHz,Tpol,workers,'TIREM',num_chunks,tf_recalc_pathloss,tf_server_status)
    %part1_calc_pathloss_dynamic_num_chunks_rev8(app,rev_folder,folder_names,parallel_flag,sim_number,reliability,confidence,FreqMHz,Tpol,workers,'TIREM',tf_recalc_pathloss,tf_server_status)
end

%%%%%%%%%As a point of comparison, ITM --> 9 mins, TIREM --> 3 hours , P2001 --> 5 hours
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Step 1: Propagation Loss (ITM)
string_prop_model='ITM'
part1_calc_pathloss_rand_chunkpt_server_rev7(app,rev_folder,folder_names,parallel_flag,sim_number,reliability,confidence,FreqMHz,Tpol,workers,string_prop_model,num_chunks,tf_recalc_pathloss,tf_server_status)
...
%%%%%%%%part2_bugsplat_maps_angles_rev5(app,rev_folder,folder_names,sim_number,reliability,string_prop_model,grid_spacing,array_reliability_check,tf_calc_rx_angle,tf_recalculate,tf_tropo_cut,tf_server_status,array_bs_eirp_reductions,array_mitigation)
part2_bugsplat_maps_angles_rescrap_rev6(app,rev_folder,folder_names,sim_number,reliability,string_prop_model,grid_spacing,array_reliability_check,tf_calc_rx_angle,tf_recalculate,tf_tropo_cut,tf_server_status,array_bs_eirp_reductions,array_mitigation,tf_rescrap_pathloss)
