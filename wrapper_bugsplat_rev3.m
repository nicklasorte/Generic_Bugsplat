function wrapper_bugsplat_rev3(app,rev_folder,parallel_flag,tf_server_status)
...
if tf_calc_rx_angle==1 %%%%%%%%%If we need to do the angles.
    ...
    %%%%%%%%%%%%TIREM in Non-parallel
    %%%part1_calc_pathloss_server_rev6(app,rev_folder,folder_names,parallel_flag,sim_number,reliability,confidence,FreqMHz,Tpol,workers,string_prop_model,num_chunks,tf_server_status)
end
...
% % % % % % % % % % % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%protection point
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%And parallel the pathloss calculation
