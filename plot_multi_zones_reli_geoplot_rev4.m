function plot_multi_zones_reli_geoplot_rev4(app,temp_zones,base_protection_pts,data_label1,string_prop_model,temp_rel,grid_spacing)
...
if ~isempty(temp_zones)
    ...
    pause(1)
    filename1=strcat('Multi_Circles','_',data_label1,'_',string_prop_model,'_',num2str(temp_rel),'%_',num2str(grid_spacing),'km.png');
