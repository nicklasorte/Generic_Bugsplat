function [max_knn_dist,convex_bound]=plot_coordination_zone_rev1_with_miti(app,max_pwr_rx_dBm,receiver_threshold,sim_array_list_bs,base_protection_pts,data_label1,string_prop_model,grid_spacing,miti_dB)


        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Calculate the coordination zone
                temp_margin=max_pwr_rx_dBm-receiver_threshold;
                idx_keep=find(temp_margin>=0);

                temp_nan_idx=find(isnan(max_pwr_rx_dBm));
                size(temp_nan_idx)
