function []=plot_nationwide_single_overlap_rev2_filename(app,sim_number,cell_poly_merge,cell_overlap_poly,filename_overlay_plot)
...
pause(1)
print(gcf,filename_overlay_plot,'-dpng','-r300')
pause(1)
close(f1)
toc;
end

%%%strcat('Overlay_Single_',num2str(sim_number),'.png')