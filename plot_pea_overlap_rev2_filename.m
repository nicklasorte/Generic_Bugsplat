function []=plot_pea_overlap_rev2_filename(app,cell_poly_merge,cell_overlap_poly,cell_pea_hist_poly,filename_PEA_plot)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%strcat('PEA_Polygon_',num2str(array_mitigation(miti_idx)),'dB_Step.png')