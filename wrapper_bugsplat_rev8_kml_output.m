function wrapper_bugsplat_rev8_kml_output(app,rev_folder,parallel_flag,tf_server_status,tf_recalculate)
...
if tf_calc_rx_angle==1 %%%%%%%%%If we need to do the angles.
    ...
    part1_calc_pathloss_point_clean_rev10(app,rev_folder,folder_names,parallel_flag,sim_number,reliability,confidence,FreqMHz,Tpol,workers,string_prop_model,tf_recalc_pathloss,tf_server_status)
end
...
part2_bugsplat_maps_both_rev8_simple(app,rev_folder,folder_names,sim_number,reliability,string_prop_model,grid_spacing,array_reliability_check,tf_calc_rx_angle,tf_recalculate,tf_tropo_cut,tf_server_status,array_bs_eirp_reductions,array_mitigation,tf_rescrap_pathloss)
...
part5_kml_file_rev1(app,folder_names,rev_folder,string_prop_model,sim_number)
