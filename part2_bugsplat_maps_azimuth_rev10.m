function part2_bugsplat_maps_azimuth_rev10(app,rev_folder,folder_names,sim_number,reliability,string_prop_model,grid_spacing,array_reliability_check,tf_calc_rx_angle,tf_recalculate,tf_tropo_cut,tf_server_status,array_mitigation,tf_rescrap_pathloss)
    ...
    for folder_idx=1:1:num_folders
        ...
        if cell_status{temp_cell_idx,2}==0
            ...
            if var_exist==2
                ...
                if num_pp_pts>1
                    'Need to expand for multiple protection points'
                    pause;
                end
                ...
                % % % figure;
                % % % hold on;
                % % % plot(sim_array_list_bs(over_pl_idx,2),sim_array_list_bs(over_pl_idx,1),'or')
                % % % plot(sim_array_list_bs(under_pl_idx,2),sim_array_list_bs(under_pl_idx,1),'xb')
