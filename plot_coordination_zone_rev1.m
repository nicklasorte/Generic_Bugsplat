function [max_knn_dist,convex_bound]=plot_coordination_zone_rev1(app,max_pwr_rx_dBm,receiver_threshold,sim_array_list_bs,base_protection_pts,data_label1,string_prop_model,grid_spacing)
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Calculate the coordination zone
                ...
                if ~isempty(idx_keep)
                    ...
                    if ~isempty(non_inf_keep_grid_pts)==1
                        ...
                        pause(0.1)
                        filename1=strcat('Convex_Bound','_',data_label1,'_',string_prop_model,'_',num2str(grid_spacing),'km.png');
