function part4_census_pop_impact_rev4(app,rev_folder,folder_names,sim_number,string_prop_model,grid_spacing,tf_recalculate,array_mitigation)
    ...
    for folder_idx=1:1:num_folders
        ...
        if cell_status{temp_cell_idx,2}==0
            ...
            if var_exist==2
                ...
                toc;
                cell_miti_contour_pop=horzcat(cell_miti_data,cell_contour_pop)
